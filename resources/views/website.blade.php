                              ...
                              <div class="caption">
                                   <div class="container">
                                        <div class="col-md-6 col-sm-12">
                                             <h1>National Gallery of  Zimbabwe </h1>
                                             <h3>The Original National Gallery Of African Modern Art In Zimbabwe</h3>
                         ...
                         <div class="item item-second">
                              <div class="caption">
                                   <div class="container">
                                        <div class="col-md-6 col-sm-12">
                                             <h1>Exhibitions</h1>
                                             <h3>We are the prime arts institution in Zimbabwe, facilitating and enhancing research,</h3>
          ...
          <div class="container">
            ...
            <div class="col-md-12 col-sm-12">
                <div class="section-title">
                    <center>  <h2>National Gallery Of Zimbabwe  Branches </h2>  </center>
                </div>
           </div>
               <div class="row">
                    ...
                    <div class="col-md-offset-1 col-md-4 col-sm-12">
                         <div class="entry-form">
                              <form action="#" method="post">
                                   ...
                                   <button class="submit-btn form-control" id="form-submit">Sign Up </button>
                              </form>
                         </div>
                    </div>
     ...
     <section id="team">
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12">
                         <div class="section-title">
                              <h2>Our Organization <small>Meet Management</small></h2>
                         </div>
                    </div>
     ...
     <section id="courses">
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12">
                         <div class="section-title">
                              <h2>Popular Events <small> Our  Previous  Events</small></h2>
                         </div>
